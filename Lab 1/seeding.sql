SELECT * from cars_bbdd;

INSERT INTO cars_bbdd (VIN, manufacturer, model, year_c, colour)
	...
	INSERT INTO customer (id_customer, customer_name, phone, email, address, city, estado_provincia, pais, zip)
